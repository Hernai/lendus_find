      ...
      >
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-6xl max-h-[90vh] overflow-hidden">
          ...
          <div v-else-if="configData" class="overflow-y-auto max-h-[65vh]">
            <!-- Branding Tab - Two Column Professional Layout -->
            <div v-show="configActiveTab === 'branding'" class="flex">
              <!-- Hidden file inputs -->
                ...
                <div>
                  ...
                  <div v-show="brandingSections.logos" class="space-y-3 mt-4">
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      >
                        <img v-if="configData.branding.logo_url" :src="configData.branding.logo_url" class="max-h-12 max-w-12 object-contain" alt="Logo" />
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      >
                        <img v-if="configData.branding.logo_dark_url" :src="configData.branding.logo_dark_url" class="max-h-12 max-w-12 object-contain" alt="Logo Dark" />
                    ...
                    <div class="flex items-center gap-3">
                      ...
                      >
                        <img v-if="configData.branding.favicon_url" :src="configData.branding.favicon_url" class="max-h-8 max-w-8 object-contain" alt="Favicon" />
                    ...
                    <div class="pt-2 border-t border-gray-100">
                      ...
                      <div class="flex flex-wrap gap-1.5">
                        <button
                          ...
                          :key="icon.name"
                          @click="selectSuggestedIcon(icon.svg, configData.branding.primary_color)"
                          ...
                          :title="icon.name"
                        >
                          <div class="w-5 h-5" :style="{ color: configData.branding.primary_color }" v-html="icon.svg"></div>
                        </button>
                      </div>
                    </div>
                  </div>
                    ...
                    <div v-for="color in [
                      ...
                      <div class="relative">
                        <div
                          ...
                          :style="{ backgroundColor: (configData.branding as Record<string, string>)[color.key] }"
                        ></div>
                        <input
                          type="color"
                          v-model="(configData.branding as Record<string, string>)[color.key]"
                      ...
                      <span class="text-xs font-mono text-gray-400">{{ (configData.branding as Record<string, string>)[color.key] }}</span>
                    </div>

                    <!-- Background & Text Colors (collapsible-style) -->
                    <div class="pt-2 border-t border-gray-100">
                ...
                <div>
                  ...
                  <div v-show="brandingSections.typography" class="space-y-3 mt-4">
                    <div>
                      ...
                      <select
                        v-model="configData.branding.font_family"
                        ...
                        :style="{ fontFamily: configData.branding.font_family }"
                      >
                    ...
                    <div class="grid grid-cols-2 gap-3">
                      <div>
                        ...
                        <select
                          v-model="configData.branding.border_radius"
                          class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-primary-400 focus:ring-2 focus:ring-primary-100 transition-all cursor-pointer"
                        >
                      ...
                      <div>
                        ...
                        <select
                          v-model="configData.branding.button_style"
                          class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-primary-400 focus:ring-2 focus:ring-primary-100 transition-all cursor-pointer"
                        >
              ...
              <div class="flex-1 bg-gray-100 p-6 overflow-y-auto" :class="{ 'hidden': !showPreview }">
                ...
                <div v-if="previewMode === 'desktop'" class="bg-white rounded-xl shadow-xl overflow-hidden border border-gray-200">
                  ...
                  <div
                    class="min-h-[400px]"
                    :style="{
                      backgroundColor: configData.branding.background_color,
                      fontFamily: configData.branding.font_family
                    }"
                  >
                    <!-- Navbar -->
                    <nav class="px-6 py-4 border-b" :style="{ borderColor: configData.branding.primary_color + '20' }">
                      <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                          <img
                            v-if="configData.branding.logo_url"
                            :src="configData.branding.logo_url"
                          ...
                          <div
                            ...
                            :style="{ backgroundColor: configData.branding.primary_color }"
                          >
                            {{ configTenant?.name?.charAt(0) }}
                          </div>
                          <span
                            class="font-semibold"
                            :style="{ color: configData.branding.text_color }"
                          >
                            {{ configTenant?.name }}
                          </span>
                        </div>
                        <div class="flex items-center gap-4">
                          <a href="#" class="text-sm hover:opacity-80 transition-opacity" :style="{ color: configData.branding.text_color }">Inicio</a>
                          <a href="#" class="text-sm hover:opacity-80 transition-opacity" :style="{ color: configData.branding.text_color }">Productos</a>
                          <button
                            class="px-4 py-2 text-white text-sm font-medium transition-all hover:opacity-90"
                            :style="{
                              backgroundColor: configData.branding.primary_color,
                              borderRadius: configData.branding.border_radius
                            }"
                          >
                            Iniciar Sesión
                          </button>
                    ...
                    <div class="px-6 py-12">
                      <div class="max-w-xl">
                        <span
                          ...
                          :style="{
                            backgroundColor: configData.branding.accent_color + '20',
                            color: configData.branding.accent_color
                          }"
                        >
                          Nuevo
                        </span>
                        ...
                        <div class="flex items-center gap-3">
                          ...
                          <button
                            ...
                            :style="{
                              color: configData.branding.secondary_color,
                              borderColor: configData.branding.secondary_color,
                              borderRadius: configData.branding.border_radius
                            }"
                          >
                            Ver Simulador
                    ...
                    <div class="px-6 pb-8">
                      <div class="grid grid-cols-3 gap-4">
                        <div
                          ...
                          :style="{
                            backgroundColor: configData.branding.background_color,
                            borderColor: configData.branding.primary_color + '20',
                            borderRadius: configData.branding.border_radius
                          }"
                        >
                          <div
                            class="w-10 h-10 rounded-lg flex items-center justify-center mb-3"
                            :style="{ backgroundColor: configData.branding.primary_color + '15' }"
                          >
                            <svg class="w-5 h-5" :style="{ color: configData.branding.primary_color }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" :d="feature.icon" />
                            </svg>
                          </div>
                          <h3 class="font-semibold text-sm mb-1" :style="{ color: configData.branding.text_color }">
                            {{ feature.title }}
                          </h3>
                          <p class="text-xs opacity-60" :style="{ color: configData.branding.text_color }">
                            {{ feature.desc }}
                          </p>
                        </div>
                      </div>
                ...
                <div v-else class="flex justify-center">
                  <div class="relative">
                    ...
                    <div class="w-[280px] h-[580px] bg-gray-900 rounded-[3rem] p-3 shadow-2xl">
                      ...
                      >
                        <!-- Status Bar -->
                        <div class="flex items-center justify-between px-6 pt-3 pb-2" :style="{ backgroundColor: configData.branding.background_color }">
                          <span class="text-xs font-medium" :style="{ color: configData.branding.text_color }">9:41</span>
                          <div class="flex items-center gap-1">
                            <svg class="w-4 h-4" :style="{ color: configData.branding.text_color }" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Mobile Navbar -->
                        <div class="flex items-center justify-between px-4 py-3 border-b" :style="{ borderColor: configData.branding.primary_color + '20' }">
                          <div class="flex items-center gap-2">
                            <img
                              v-if="configData.branding.logo_url"
                              :src="configData.branding.logo_url"
                            ...
                            <span class="font-semibold text-sm" :style="{ color: configData.branding.text_color }">
                              {{ configTenant?.name }}
                            </span>
                          </div>
                          <button class="p-1" :style="{ color: configData.branding.text_color }">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <!-- Mobile Stats -->
                        <div class="flex justify-around px-4 py-4 border-t border-b" :style="{ borderColor: configData.branding.primary_color + '10' }">
                          <div class="text-center">
                            <p class="text-sm font-bold" :style="{ color: configData.branding.primary_color }">24hrs</p>
                            <p class="text-[10px] opacity-60" :style="{ color: configData.branding.text_color }">Respuesta</p>
                          </div>
                          <div class="text-center">
                            <p class="text-sm font-bold" :style="{ color: configData.branding.primary_color }">0%</p>
                            <p class="text-[10px] opacity-60" :style="{ color: configData.branding.text_color }">Comisión</p>
                          </div>
                          <div class="text-center">
                            <p class="text-sm font-bold" :style="{ color: configData.branding.primary_color }">48</p>
                            <p class="text-[10px] opacity-60" :style="{ color: configData.branding.text_color }">Meses</p>
                          </div>
                        </div>
                        ...
                        <div class="p-4 space-y-2">
                          ...
                          >
                            <div
                              ...
                              :style="{ backgroundColor: configData.branding.primary_color + '15' }"
                            >
                              <svg class="w-4 h-4" :style="{ color: configData.branding.primary_color }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" :d="feature.icon" />
                              </svg>
                            </div>
                            <div>
                              <p class="text-xs font-semibold" :style="{ color: configData.branding.text_color }">{{ feature.title }}</p>
                              <p class="text-[10px] opacity-60" :style="{ color: configData.branding.text_color }">{{ feature.desc }}</p>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="mt-4 flex items-center justify-center gap-2">
                  ...
                  <div
                    class="w-8 h-8 rounded-lg shadow-sm border border-white"
                    :style="{ backgroundColor: configData.branding.secondary_color }"
                    title="Secundario"
                  ></div>
                  <div
                    class="w-8 h-8 rounded-lg shadow-sm border border-white"
                    :style="{ backgroundColor: configData.branding.accent_color }"
                    title="Acento"
                  ></div>
                  <div class="w-px h-6 bg-gray-300 mx-1"></div>
                  <div
                    class="w-8 h-8 rounded-lg shadow-sm border border-gray-300"
                    :style="{ backgroundColor: configData.branding.background_color }"
                    title="Fondo"
                  ></div>
                  <div
                    class="w-8 h-8 rounded-lg shadow-sm border border-gray-300"
                    :style="{ backgroundColor: configData.branding.text_color }"
                    title="Texto"
                  ></div>
                </div>
              </div>
