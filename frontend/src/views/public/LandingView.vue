          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div class="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <AppButton variant="secondary" size="lg" fullWidth class="sm:w-auto bg-primary-100 text-primary-700 border-primary-200 hover:bg-primary-200" @click="showRequirementsModal = true">
