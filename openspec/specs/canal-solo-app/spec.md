...
La solicitud de crédito puede restringirse a la app móvil mediante un feature flag por tenant (app_only_channel), con la web como canal informativo y de descarga; el simulador se conserva como gancho.
