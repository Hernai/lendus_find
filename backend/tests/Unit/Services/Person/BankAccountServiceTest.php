...
class BankAccountServiceTest extends TestCase
{
    ...
    public function test_can_deactivate_account(): void
    {
        ...
        $this->assertEquals(BankAccount::STATUS_INACTIVE, $deactivated->status);
    }
    ...
    public function test_can_close_account(): void
    {
        ...
        $this->assertEquals(BankAccount::STATUS_CLOSED, $closed->status);
    ...
    public function test_can_freeze_account(): void
    {
        ...
        $this->assertEquals(BankAccount::STATUS_FROZEN, $frozen->status);
    }
    ...
    public function test_can_reactivate_account(): void
    {
        ...
        $this->assertEquals(BankAccount::STATUS_ACTIVE, $reactivated->status);
    }
    ...
    {
        $existing = BankAccount::factory()->notPrimary()->create([
            'tenant_id' => $this->tenant->id,
            'owner_type' => 'persons',
            'owner_id' => $this->person->id,
            'clabe' => '012180000000000015',
    ...
    {
        BankAccount::factory()->verified()->active()->forDisbursement()->create([
            'tenant_id' => $this->tenant->id,
            'owner_type' => 'persons',
            'owner_id' => $this->person->id,
        ]);
        BankAccount::factory()->unverified()->active()->forDisbursement()->create([
            'tenant_id' => $this->tenant->id,
            'owner_type' => 'persons',
            'owner_id' => $this->person->id,
        ]);
    ...
    {
        BankAccount::factory()->primary()->verified()->active()->create([
            'tenant_id' => $this->tenant->id,
            'owner_type' => 'persons',
            'owner_id' => $this->person->id,
            'bank_name' => 'BBVA',
        ...
        BankAccount::factory()->notPrimary()->unverified()->active()->create([
            'tenant_id' => $this->tenant->id,
            'owner_type' => 'persons',
            'owner_id' => $this->person->id,
        ]);
