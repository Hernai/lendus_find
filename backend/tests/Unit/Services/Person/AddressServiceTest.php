...
class AddressServiceTest extends TestCase
{
    ...
    public function test_can_verify_address(): void
    {
        ...
        $this->assertEquals(Address::STATUS_VERIFIED, $verified->status);
    ...
    public function test_can_reject_address(): void
    {
        ...
        $this->assertEquals(Address::STATUS_REJECTED, $rejected->status);
    }

    public function test_can_replace_address(): void
    {
        $old = Address::factory()->home()->verified()->current()->create([
            'tenant_id' => $this->tenant->id,
            'person_id' => $this->person->id,
            'street' => 'Old Street',
        ]);
    ...
    {
        Address::factory()->home()->verified()->current()->create([
            'tenant_id' => $this->tenant->id,
            'person_id' => $this->person->id,
        ]);
    ...
    public function test_get_history(): void
    {
        ...
        Address::factory()->home()->historical()->count(2)->create([
            'tenant_id' => $this->tenant->id,
            'person_id' => $this->person->id,
        ]);
