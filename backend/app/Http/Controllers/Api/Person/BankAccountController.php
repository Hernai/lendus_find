...
use App\Http\Resources\Person\BankAccountResource;
...
class BankAccountController extends Controller
{
     ...
     * Show a bank account.
     */
    public function show(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function update(Request $request, Person $person, BankAccount $bankAccount): BankAccountResource
    {
        $validated = $request->validate([
     ...
     */
    public function destroy(Person $person, BankAccount $bankAccount): JsonResponse
    {
     ...
     */
    public function setPrimary(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function setPrimaryAccount(Request $request, Person $person): BankAccountResource
    {
        $validated = $request->validate([
            'bank_name' => 'required|string|max:100',
            'bank_code' => 'nullable|string|max:10',
     ...
     */
    public function verify(Request $request, Person $person, BankAccount $bankAccount): BankAccountResource
    {
        $validated = $request->validate([
     ...
     */
    public function unverify(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function deactivate(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function reactivate(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function close(Person $person, BankAccount $bankAccount): BankAccountResource
    {
     ...
     */
    public function freeze(Person $person, BankAccount $bankAccount): BankAccountResource
    {
