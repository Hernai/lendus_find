...
/**
 * Address with version history (polymorphic).
 *
 * Stores addresses with full history tracking. When an entity moves,
 ...
 * @property-read Address|null $previousVersion
 */
class Address extends Model
{
    ...
    /**
     * Get the entity that owns this address (polymorphic).
     */
    ...
    /**
     * Replace with a new address (entity moved).
     */
    ...
    /**
     * Find current address by type for any entity.
     */
    public static function findCurrentByTypeForEntity(string $entityType, string $entityId, string $type): ?self
    {
